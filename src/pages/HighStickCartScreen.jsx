...
import HighStickCartItemComponent from '../components/HighStickCartItemComponent';
import HighStickComponent from '../components/HighStickComponent';
        ...
        <>
          <View style={{height: height * 0.7}}>
            <ScrollView style={styles.flex} contentContainerStyle={styles.main}>
              {cart.map((item, index) => (
                <HighStickCartItemComponent item={item} key={index} />
              ))}
            </ScrollView>
          </View>
        </>
